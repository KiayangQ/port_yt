...
export var DonationPage = function (props) {
    ...
    var platform = props.platform, locale = props.locale;
    ...
    // }
    var footer = (_jsx(Footer, { middle: _jsx(Progress, { percentage: props.footer.progressPercentage }), right: _jsx("div", __assign({ className: 'flex flex-row' }, { children: _jsx("div", { className: 'flex-grow' }) })) }));
